...
export function Logo() {
  return (
    <Link href="#top" className="inline-flex items-center gap-3" aria-label="Muz'Deen accueil">
      ...
      <span className="leading-none">
        ...
        <span className="block text-xs font-medium text-[color:var(--ui-muted)]">For Here and Beyond</span>
      </span>
    </Link>
  );
}
